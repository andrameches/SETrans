...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '
     <tr>
        <td>
           ' . $x . '
           <form action="../SETrans/customer/modifyBooking.php" target="_blank" method="post" id="formmodadm' . $x . '"></form>
           <form action="../SETrans/customer/deleteBooking.inc.php" method="post" id="formdeladm' . $x . '"></form>
        </td>
        <td>' . $row['id'] . '
