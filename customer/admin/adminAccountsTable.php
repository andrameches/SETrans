...
while ($row = mysqli_fetch_assoc($result)) {
    echo '
     <tr>
        <td>
           ' . $x . '
           <form action="../SETrans/customer/modifyAccount.php" target="_blank" method="post" id="formmodaccadm' . $x . '"></form>
           <form action="../SETrans/deleteAccount.inc.php" method="post" id="formdelaccadm' . $x . '"></form>
        </td>
        <td>' . $row['account_id'] . '
